...
.red-ui-tab-scroll-left {
  left: 0;
  a {
    border-right: 1px solid $primary-border-color; // box-shadow: 8px 0px 5px -2px rgba(0,0,0,0.1);
  }
}
...
.red-ui-tab-scroll-right {
  right: 0px;
  a {
    border-left: 1px solid $primary-border-color; // box-shadow: -8px 0px 5px -2px rgba(0,0,0,0.1);
  }
}
